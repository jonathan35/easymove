<?php /*
<div style="position:fixed; left:0; z-index:1; color:white;
box-shadow:2px -2px 10px rgba(0,0,0,.2);">

<a href="http://wphp.hopto.org/easymove/android_merchant_registration.php">Driver Application</a><br><br>

<a href="https://wphp.hopto.org/easymove/android_order.php">Driver Dashboard</a><br><br>
...
<div class="col-12 p-1 text-center text-white" style="position:fixed; width:320px; top:553px; z-index:1; background:#ffa800;
