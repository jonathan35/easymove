...
$keywordMustFullWord=true;
$keywordFields=array('company_name', 'contact_person');
...
$fields = array('id', 'company_name', 'status');//, 'address'
$value = array();
$type = array();
...
$type['default_location'] = 'map';
$type['default_location_coordinate'] = 'coordinate';

$labelFullRow['default_location'] = true;
...
*/
$cols = $items =array();
$cols = array('Company' => '8', 'Status' => '4');//Column title and width
$items['Company'] = array('company_name');
...
<div class="row">
	...
	<div class="col-12">
		<div class="row">
			...
			Please record & give username & password to merchant to allowing their login access.
			</div>
		</div>
