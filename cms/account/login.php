...
$fields = array('id', 'admin_group', 'region', 'name', 'email', 'status', 'username', 'password');
$value = array();
$type = array();
...
$type['admin_group'] = 'select'; $option['admin_group'] = array('1'=>'Master Admin (All Region)', '2'=>'Region Admin');
...
$type['label'] = 'region <br>(only for store admin)';
