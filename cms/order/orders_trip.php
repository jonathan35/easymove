...
$results = sql_read("select id, branch_name from branch $branch_ext order by branch_name ASC");
foreach((array)$results as $a){
...
$results = sql_read("select id, name, mobile_number from driver where status =1 driver_ext order by name ASC");
foreach((array)$results as $a){
