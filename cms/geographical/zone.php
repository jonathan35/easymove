...
if($_SESSION['validation']=='YES'){
	...
	header("zone:../authentication/login.php");
}

$table = 'zone';
$module_name = 'zone';
$php = 'zone';
$folder = 'geographical';//auto refresh row once edit modal closed
$add = true;
$edit = true;
$list = true;
$list_method = 'list';
...
$fields = array('id', 'region', 'zone', 'position', 'status');
$value = array();
$type = array();
...
$attribute['zone'] = array('required' => 'required');
...
*/
$cols = $items =array();
$cols = array('Region' => '4', 'zone' => '4', 'Position' => '4');//Column title and width
$items['Region'] = array('region');
$items['zone'] = array('zone');
...
<link rel="stylesheet" href="<?php echo ROOT?>cms/js/datepicker/jquery-ui.css">
<link rel="stylesheet" href="<?php echo ROOT?>cms/js/datepicker/style.css">
<script src="<?php echo ROOT?>cms/js/datepicker/jquery-1.12.4.js"></script>
<script src="<?php echo ROOT?>cms/js/datepicker/jquery-ui.js"></script>
<script>
$( function() {
